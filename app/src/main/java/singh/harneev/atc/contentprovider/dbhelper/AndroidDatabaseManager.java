package singh.harneev.atc.contentprovider.dbhelper;//add your package name here example: package com.example.dbm;
...
import singh.harneev.atc.contentprovider.DB;

public class AndroidDatabaseManager extends Activity implements OnItemClickListener {

    private static final int ANDROID_DATABASE_MANAGER_RES_ID = 299;
...
// all global variables
    ...
    public void updateDeletePopup(int row) {
        ...
        lcrud.setId(ANDROID_DATABASE_MANAGER_RES_ID);
